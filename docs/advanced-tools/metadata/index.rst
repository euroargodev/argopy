...
The **argopy** approach to meta-data is not limited to the traditional `meta` netcdf files well known to operators and experts.
...
* :doc:`Argo sensor models and types <sensors>`
...
.. toctree::
    ...
    admt_documentation
    deployment_plan
    Argo sensor models and types <sensors>
