# -*- coding: utf-8 -*-
#
# argopy documentation build configuration file, created by
...
import argopy
print("argopy: %s, %s, %s" % (argopy.__version__, argopy.__file__, __version__))
...
# of the sidebar.
html_logo = "_static/argopy_90.png"
