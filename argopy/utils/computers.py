...
def _linear_interp_legacy(x: np.array, y: np.array, xi: np.array) -> np.array:
...
def _linear_interp(x: np.array, y: np.array, xi: np.array) -> np.array:
    """:func:`scipy.interpolate.interp1d` interpolation of a profile
...
def _pchip_interp(x: np.array, y: np.array, xi: np.array, xTolerance: np.array = None) -> np.array:
