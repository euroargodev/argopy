...
from argopy.sensors.accessories import SensorType, SensorModel, Error, ErrorOptions


log = logging.getLogger("argopy.sensors.ref")
...
@register_accessor("type", ArgoSensorReferences)
class SensorExtension(SensorReferenceR25):
    _name = "ref.type"


@register_accessor("maker", ArgoSensorReferences)
class MakerExtension(SensorReferenceR26):
    _name = "ref.maker"


@register_accessor("model", ArgoSensorReferences)
